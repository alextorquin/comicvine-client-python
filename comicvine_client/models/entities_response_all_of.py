...
class EntitiesResponseAllOf(object):
    ...
    @property
    def results(self):
        """Gets the results of this EntitiesResponseAllOf.  # noqa: E501
    ...
    def results(self, results):
        """Sets the results of this EntitiesResponseAllOf.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EntitiesResponseAllOf):
            return False
