...
class EntitiesResponse(object):
    ...
    def status_code(self):
        """Gets the status_code of this EntitiesResponse.  # noqa: E501
        ...
        :return: The status_code of this EntitiesResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def status_code(self, status_code):
        """Sets the status_code of this EntitiesResponse.

        An integer indicating the result of the request. Acceptable values are:   - 1:OK   - 100:Invalid API Key   - 101:Object Not Found   - 102:Error in URL Format   - 103:'jsonp' format requires a 'json_callback' argument   - 104:Filter Error   - 105:Subscriber only video is for subscribers only   # noqa: E501

        :param status_code: The status_code of this EntitiesResponse.  # noqa: E501
        :type: int
        """
    ...
    @property
    def error(self):
        """Gets the error of this EntitiesResponse.  # noqa: E501

        A text string representing the status_code  # noqa: E501

        :return: The error of this EntitiesResponse.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this EntitiesResponse.

        A text string representing the status_code  # noqa: E501

        :param error: The error of this EntitiesResponse.  # noqa: E501
        :type: str
        """
    ...
    def number_of_total_results(self):
        """Gets the number_of_total_results of this EntitiesResponse.  # noqa: E501

        The number of total results matching the filter conditions specified  # noqa: E501

        :return: The number_of_total_results of this EntitiesResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def number_of_total_results(self, number_of_total_results):
        """Sets the number_of_total_results of this EntitiesResponse.

        The number of total results matching the filter conditions specified  # noqa: E501

        :param number_of_total_results: The number_of_total_results of this EntitiesResponse.  # noqa: E501
        :type: int
        """
    ...
    def number_of_page_results(self):
        """Gets the number_of_page_results of this EntitiesResponse.  # noqa: E501

        The number of results on this page  # noqa: E501

        :return: The number_of_page_results of this EntitiesResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def number_of_page_results(self, number_of_page_results):
        """Sets the number_of_page_results of this EntitiesResponse.

        The number of results on this page  # noqa: E501

        :param number_of_page_results: The number_of_page_results of this EntitiesResponse.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def results(self):
        """Gets the results of this EntitiesResponse.  # noqa: E501
    ...
    def results(self, results):
        """Sets the results of this EntitiesResponse.
