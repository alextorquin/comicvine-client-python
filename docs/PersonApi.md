# comicvine_client.PersonApi

All URIs are relative to *https://comicvine.gamespot.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_person**](PersonApi.md#get_person) | **GET** /person/{id} | Get a particular person


# **get_person**
> EntityResponse get_person(id, format=format, field_list=field_list)
...
|-------------|-------------|------------------|
**200** | Information about the person |  -  |
